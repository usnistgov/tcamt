...
public class Message extends DataModelWithConstraints implements java.io.Serializable, Cloneable,
  ...
  public String toString() {
    return "Message [id=" + id + ", identifier=" + identifier + ", messageID=" + messageID
        + ", name=" + name + ", messageType=" + messageType + ", event=" + event + ", structID="
        + structID + ", description=" + description + ", children=" + children + ", position="
        + position + ", comment=" + comment + ", usageNote=" + usageNote + ", predicates="
