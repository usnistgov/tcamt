...
@Entity
@Table
public class IsolatedTestCaseGroup implements Cloneable, Serializable{
	...
	@Override
	public IsolatedTestCaseGroup clone() throws CloneNotSupportedException {
		IsolatedTestCaseGroup cloned = (IsolatedTestCaseGroup)super.clone();
		cloned.setId(0);
